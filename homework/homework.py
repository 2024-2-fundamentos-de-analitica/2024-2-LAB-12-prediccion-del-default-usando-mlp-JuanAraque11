...
# Optimizar  hiperparametros del pipeline con validación cruzada.
...
# Calcularmetricas de precision, precision balanceada, recall y f1-score
...
# Calcular  matrices de confusion para entrenamiento y prueba
